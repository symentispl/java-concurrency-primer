...
digraph interleave {
    ...
    A1 [label="LOAD counter → 5",  fillcolor="#4a90d9", fontcolor=white]
    A2 [label="ADD  5+1=6",        fillcolor="#4a90d9", fontcolor=white]
    A3 [label="STORE counter=6",   fillcolor="#4a90d9", fontcolor=white]

    B1 [label="LOAD counter → 5",  fillcolor="#c97c2e", fontcolor=white]
    B2 [label="ADD  5+1=6",        fillcolor="#c97c2e", fontcolor=white]
    B3 [label="STORE counter=6",   fillcolor="#c97c2e", fontcolor=white]
